...
| Provisional boundaries remaining | 103 |
| Reviewed/corroborated authored boundaries | 629 |
| Source-present accepted `MAIN.EXE` mappings | 270 |
| Accepted exact `MAIN.EXE` functions | 270 |
| Accepted exact authored bytes | 40,638 |

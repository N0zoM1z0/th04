...
| Provisional boundaries remaining | 77 |
| Reviewed/corroborated authored boundaries | 645 |
| Source-present accepted `MAIN.EXE` mappings | 331 |
| Accepted exact `MAIN.EXE` functions | 331 |
| Accepted exact authored bytes | 54,312 |

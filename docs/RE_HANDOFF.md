...
- v421 focused replay and the complete 282-owner default candidate aggregate both close the 90-byte carpet hybrid producer with zero failures. The candidate remains unaddressed and zero-credit pending explicit v409/v410 ownership migration and post-migration aggregate.

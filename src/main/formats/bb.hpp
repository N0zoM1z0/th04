#ifndef TH04_MAIN_FORMATS_BB_HPP
#define TH04_MAIN_FORMATS_BB_HPP
...
// to the newly allocated segment. Does not free an existing allocation.
...
// Puts the given TXT*.BB sprite at (floor(left/8)*8, top). ES must already
// point at the intended VRAM plane and the GRCG must be active.

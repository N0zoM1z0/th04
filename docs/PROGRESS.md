...
| Provisional boundaries remaining | 101 |
| Reviewed/corroborated authored boundaries | 631 |
| Source-present accepted `MAIN.EXE` mappings | 276 |
| Accepted exact `MAIN.EXE` functions | 276 |
| Accepted exact authored bytes | 42,229 |

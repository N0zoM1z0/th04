...
| Provisional boundaries remaining | 99 |
| Reviewed/corroborated authored boundaries | 633 |
| Source-present accepted `MAIN.EXE` mappings | 285 |
| Accepted exact `MAIN.EXE` functions | 285 |
| Accepted exact authored bytes | 43,709 |

...
| Provisional boundaries remaining | 100 |
| Reviewed/corroborated authored boundaries | 632 |
| Source-present accepted `MAIN.EXE` mappings | 281 |
| Accepted exact `MAIN.EXE` functions | 281 |
| Accepted exact authored bytes | 43,033 |

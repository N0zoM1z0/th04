...
| Provisional boundaries remaining | 97 |
| Reviewed/corroborated authored boundaries | 635 |
| Source-present accepted `MAIN.EXE` mappings | 290 |
| Accepted exact `MAIN.EXE` functions | 289 |
| Accepted exact authored bytes | 45,253 |
| Exact / currently confirmed authored bytes | 99.58% |

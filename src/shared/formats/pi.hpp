#ifndef TH04_SHARED_FORMATS_PI_HPP
#define TH04_SHARED_FORMATS_PI_HPP
...
// These helpers were cdecl in TH02 and changed to Pascal from TH03 onward.
#if (GAME >= 3)
#define PI_CALL TH04_PASCAL
#else
#define PI_CALL TH04_CDECL
#endif

// >=TH03 free any previously loaded PI in the given slot before loading [fn].
int PI_CALL pi_load(int slot, const char TH04_PTR *fn);
...
// if it exceeds the clipping frame defined via grc_setclip().

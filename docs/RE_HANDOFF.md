...
- v487 restores that historical SCORE physical producer: `score_d` (0x58) +
  `score_hi` (0x211) + v486 SCORE compile as one grouped `SCORE_TEXT` TC86 TU.
  The preceding 0x269 bytes naturally shift LEDATA batching to 0x400/0x3FD/0x333
  while one top-level `#pragma codeseg SCORE_TEXT score_01` preserves group-

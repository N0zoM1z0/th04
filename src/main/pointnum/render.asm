; Point-number renderer for TH04.
;
; The width of the currently rendered number is intentionally written into the
; immediate operand of @@set_width. This code-owned state is part of the target

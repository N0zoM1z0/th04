...
| Provisional boundaries remaining | 106 |
| Reviewed/corroborated authored boundaries | 626 |
| Source-present accepted `MAIN.EXE` mappings | 259 |
| Accepted exact `MAIN.EXE` functions | 259 |
| Accepted exact authored bytes | 39,098 |

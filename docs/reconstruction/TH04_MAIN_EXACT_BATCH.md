...
`config/evidence.csv`, and `config/knowledge.csv` retain the former v1-v102
...
v99-v102 expand the reviewed denominator outside the completed MAIN_036 frontier.
...
(32,16), disproving the initial reversed hypothesis. Focused and 140-owner
aggregate cold replays preserve raw bytes, exact map contribution, ordered
relocation overlap, and deterministic TC86 OMF. Segment suffixes remain natural
C++ without manufactured padding. Candidate-C++ paths that require inline

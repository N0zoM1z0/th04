...
- The current reviewed authored byte denominator is 16,420 bytes across 60
  reviewed authored units/regions; 16,416 bytes across 57 units/regions are exact.

...
43 decoded-exact functions / 3,410 exact source-owner bytes, with two separate
codec candidates (274 bytes) still source-present and nonexact, for 3,684
...
decoded-function totals are 43/43 OP and 34/34 MAINE. The next unit is not

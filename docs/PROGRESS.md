...
| Provisional boundaries remaining | 78 |
| Reviewed/corroborated authored boundaries | 644 |
| Source-present accepted `MAIN.EXE` mappings | 326 |
| Accepted exact `MAIN.EXE` functions | 326 |
| Accepted exact authored bytes | 53,154 |

...
| Measure | Count |
| --- | ---: |
| Tracked all-artifact authored function candidates | 673 |
...
| Accepted exact `MAIN.EXE` functions | 491 |
| Accepted exact authored bytes | 83,177 |
| Exact / currently confirmed authored bytes | 99.65% |

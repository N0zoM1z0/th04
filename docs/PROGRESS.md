...
| Provisional boundaries remaining | 83 |
| Reviewed/corroborated authored boundaries | 639 |
| Source-present accepted `MAIN.EXE` mappings | 312 |
| Accepted exact `MAIN.EXE` functions | 312 |
| Accepted exact authored bytes | 49,808 |

...
| Provisional boundaries remaining | 104 |
| Reviewed/corroborated authored boundaries | 628 |
| Source-present accepted `MAIN.EXE` mappings | 269 |
| Accepted exact `MAIN.EXE` functions | 269 |
| Accepted exact authored bytes | 40,453 |

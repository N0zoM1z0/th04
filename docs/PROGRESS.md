...
| Provisional boundaries remaining | 74 |
| Reviewed/corroborated authored boundaries | 648 |
| Source-present accepted `MAIN.EXE` mappings | 339 |
| Accepted exact `MAIN.EXE` functions | 339 |
| Accepted exact authored bytes | 55,313 |

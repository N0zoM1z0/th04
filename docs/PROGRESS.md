...
| Provisional boundaries remaining | 81 |
| Reviewed/corroborated authored boundaries | 641 |
| Source-present accepted `MAIN.EXE` mappings | 321 |
| Accepted exact `MAIN.EXE` functions | 321 |
| Accepted exact authored bytes | 51,659 |

...
| Provisional boundaries remaining | 98 |
| Reviewed/corroborated authored boundaries | 634 |
| Source-present accepted `MAIN.EXE` mappings | 286 |
| Accepted exact `MAIN.EXE` functions | 286 |
| Accepted exact authored bytes | 43,968 |

...
The shared hardware/PI/sound cohort is complete. MAINE now also has five
...
renderer with two separately attested near-call fixups. MAINE now has 18 functions / 1,887 decoded
...
v541 and its first five SCORE_TEXT functions are accepted after v543-v549;
move next to the adjacent places dispatcher and other SCORE_TEXT owners, then small
